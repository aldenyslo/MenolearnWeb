...
const Results: React.FC = () => {
  ...
  const stage = (searchParams.get('stage') as keyof typeof stages) || 'post-menopause'; // Default to pre-menopause if undefined
  ...
  return (
    <div className="container mx-auto p-4 text-center">
      ...
      <Image src={stageInfo.image} alt={stageInfo.title} width={300} height={300} className="mx-auto mb-4" />
